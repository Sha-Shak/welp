    ...
    <div>
      <nav className="h-20 bg-indigo text-gray-xlight border-b-2 border-gray-xlight rounded-tr rounded-tl flex justify-between items-center">
        <div className="flex justify-center items-center">
          ...
          <img
            src={
              contact
                ? contact.img_url
                  ? contact.img_url
                  : "https://res.cloudinary.com/dl2tsdbcf/image/upload/v1661089877/pngwing.com_koueol.png"
                : undefined
            }
          ...
          {contact ? (
            contact.type === "admin" ? (
              <span className="bg-gray-xlight/50 text-gray-dark text-xs font-semibold mr-2 ml-3 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                Admin
              </span>
            ) : null
          ) : null}
